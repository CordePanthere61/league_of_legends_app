...
public class ChampionRepository : Repository<Champion>
{
    ...
    public override Champion Handle(DataRow dr)
    {
        ...
        // champion.IdSpecie = dr.Field<int>("champion.IdSpecie");
        champion.IdDifficulty = dr.Field<int>("champion.IdDifficulty");
        champion.IdRegion = dr.Field<int>("champion.IdRegion");
        champion.Name = dr.Field<string>("champion.Name");
        champion.Alias = dr.Field<string>("champion.Alias");
        champion.ReleaseDate = dr.Field<DateTime>("champion.ReleaseDate");
